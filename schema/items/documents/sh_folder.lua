--[[
    ...
    A document folder/binder for storing many papers.
    Capacity: 250 papers (25x10 grid)
    Only paper items can be stored inside.
]]--

ITEM.name = "Document Folder"
ITEM.description = "A folder for organizing documents."
ITEM.model = "models/props_lab/binderblue.mdl"  -- Placeholder
ITEM.width = 2
ITEM.height = 2
...
ITEM.functions.Rename = {
    name = "Name",
    tip = "Write a name on this folder.",
    ...
    OnClick = function(item)
        ...
        Derma_StringRequest(
            "Name Folder",
            "Write a name on this folder (max 32 characters):",
            currentName,
            function(text)
                if text then
...
ITEM.functions.View = {
    name = "Open",
    tip = "Open the folder to view contents.",
