...
local COLOR_DECIMAL = Color(200, 200, 200)
...
function PANEL:BuildUI()
    ...
    self.cancelBtn:SetTextColor(Color(200, 200, 200))
    ...
    self.confirmBtn:SetTextColor(Color(200, 200, 200))
    ...
    self.resetBtn:SetTextColor(Color(200, 200, 200))
